...
public:
    ...
    [[nodiscard]] constexpr StoredType & get()
    {
        return value_;
    }

    [[nodiscard]] constexpr std::remove_reference_t<StoredType> const & get() const
    {
        return value_;
    }
...
template<typename Type>
[[nodiscard]] constexpr ValueStorage<Type>
...
template<typename Type>
[[nodiscard]] constexpr ErrorStorage<Type>
